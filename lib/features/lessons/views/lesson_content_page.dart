...
class _LessonContentPageState extends ConsumerState<LessonContentPage> {
  ...
  void initState() {
    ...
    final start = widget.level.levelIndex * 3;
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('${widget.level.title} terminé !',
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: widget.color),
                textAlign: TextAlign.center),
            const SizedBox(height: 8),
                        Text('Vous avez complété ${_courses.length} cours. Excellent travail !',
                textAlign: TextAlign.center, style: const TextStyle(color: Colors.grey)),
            const SizedBox(height: 24),
            const Text('🏆 Niveau marqué comme terminé !', 
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ref.read(userProgressProvider.notifier).markLevelAsCompleted(widget.level);
                  Navigator.of(ctx).pop();
                  context.pop();
                },
                child: const Text('Retour aux niveaux', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ),
            ),
          ),
        ],
