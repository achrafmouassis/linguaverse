...
final languagesProvider = Provider<List<Language>>((ref) {
  return const [
    ...
    Language(id: 'fr', name: 'Français', flagEmoji: '🇫🇷', color: Color(0xFF58CC02)), // Duolingo Green
    Language(id: 'en', name: 'Anglais', flagEmoji: '🇬🇧', color: Color(0xFFFF4B4B)), // Duolingo Red
    Language(id: 'es', name: 'Espagnol', flagEmoji: '🇪🇸', color: Color(0xFFFFC800)), // Duolingo Yellow
    Language(id: 'it', name: 'Italien', flagEmoji: '🇮🇹', color: Color(0xFFFF9600)), // Duolingo Orange
    Language(id: 'tr', name: 'Turc', flagEmoji: '🇹🇷', color: Color(0xFFCE82FF)), // Duolingo Purple
