...
class LessonItem {
  ...
  final String translation;   // Traduction en français
  ...
  static Map<String, Map<String, List<LessonItem>>> content = {
    ...
    'ar': {
      ...
      'cat_couleurs_ar': [
        ...
        LessonItem(term: 'بُنِّي', pronunciation: 'Bunnī', translation: 'Marron', example: 'الخبز بُنِّي = Le pain est marron', emoji: '🟫'),
    ...
    'fr': {
      'cat_nombres_fr': [
        LessonItem(term: 'Zéro', pronunciation: 'zé-RO', translation: '0 — Zero', example: 'Zéro point = Zero points', emoji: '0️⃣'),
        LessonItem(term: 'Un', pronunciation: 'UN (nasal)', translation: '1 — One', example: 'Un chat = One cat', emoji: '1️⃣'),
        LessonItem(term: 'Deux', pronunciation: 'DUH', translation: '2 — Two', example: 'Deux amis = Two friends', emoji: '2️⃣'),
        LessonItem(term: 'Trois', pronunciation: 'TRWAH', translation: '3 — Three', example: 'Trois jours = Three days', emoji: '3️⃣'),
        LessonItem(term: 'Quatre', pronunciation: 'KAH-truh', translation: '4 — Four', example: 'Quatre saisons = Four seasons', emoji: '4️⃣'),
        LessonItem(term: 'Cinq', pronunciation: 'SANK', translation: '5 — Five', example: 'Cinq doigts = Five fingers', emoji: '5️⃣'),
        LessonItem(term: 'Six', pronunciation: 'SEES', translation: '6 — Six', example: 'Six mois = Six months', emoji: '6️⃣'),
        LessonItem(term: 'Sept', pronunciation: 'SET', translation: '7 — Seven', example: 'Sept jours = Seven days', emoji: '7️⃣'),
        LessonItem(term: 'Huit', pronunciation: 'WEET', translation: '8 — Eight', example: 'Huit heures = Eight hours', emoji: '8️⃣'),
        LessonItem(term: 'Neuf', pronunciation: 'NUF', translation: '9 — Nine', example: 'Neuf vies = Nine lives', emoji: '9️⃣'),
      ],
    },
    // ───────── TURC ─────────
    'tr': {
      'cat_nombres_tr': [
        LessonItem(term: 'Sıfır', pronunciation: 'SIF-ir', translation: '0 — Zéro', example: 'Sıfır hata = Zéro erreur', emoji: '0️⃣'),
        LessonItem(term: 'Bir', pronunciation: 'BEER', translation: '1 — Un', example: 'Bir elma = Une pomme', emoji: '1️⃣'),
        LessonItem(term: 'İki', pronunciation: 'EE-kee', translation: '2 — Deux', example: 'İki kedi = Deux chats', emoji: '2️⃣'),
        LessonItem(term: 'Üç', pronunciation: 'OOCH', translation: '3 — Trois', example: 'Üç gün = Trois jours', emoji: '3️⃣'),
        LessonItem(term: 'Dört', pronunciation: 'DORT', translation: '4 — Quatre', example: 'Dört mevsim = Quatre saisons', emoji: '4️⃣'),
        LessonItem(term: 'Beş', pronunciation: 'BESH', translation: '5 — Cinq', example: 'Beş parmak = Cinq doigts', emoji: '5️⃣'),
        LessonItem(term: 'Altı', pronunciation: 'AL-ti', translation: '6 — Six', example: 'Altı ay = Six mois', emoji: '6️⃣'),
        LessonItem(term: 'Yedi', pronunciation: 'YEH-dee', translation: '7 — Sept', example: 'Yedi gün = Sept jours', emoji: '7️⃣'),
        LessonItem(term: 'Sekiz', pronunciation: 'SEH-keez', translation: '8 — Huit', example: 'Sekiz saat = Huit heures', emoji: '8️⃣'),
        LessonItem(term: 'Dokuz', pronunciation: 'doh-KOOZ', translation: '9 — Neuf', example: 'Dokuz hayat = Neuf vies', emoji: '9️⃣'),
      ],
      'cat_salutations_tr': [
        LessonItem(term: 'Merhaba', pronunciation: 'mer-HA-ba', translation: 'Bonjour / Salut', example: 'Merhaba! Nasılsın? = Salut ! Comment vas-tu ?', emoji: '👋'),
        LessonItem(term: 'Günaydın', pronunciation: 'gün-AY-din', translation: 'Bonjour (matin)', example: 'Günaydın, öğretmenim! = Bonjour, professeur !', emoji: '🌅'),
        LessonItem(term: 'Teşekkürler', pronunciation: 'teh-shek-ür-LER', translation: 'Merci', example: 'Çok teşekkürler! = Merci beaucoup !', emoji: '🙏'),
        LessonItem(term: 'Lütfen', pronunciation: 'LÜT-fen', translation: 'S\'il vous plaît', example: 'Lütfen yardım et = Aide-moi s\'il te plaît', emoji: '🙏'),
        LessonItem(term: 'Evet', pronunciation: 'EH-vet', translation: 'Oui', example: 'Evet, tabii ki = Oui, bien sûr', emoji: '✅'),
        LessonItem(term: 'Hayır', pronunciation: 'HA-yir', translation: 'Non', example: 'Hayır, teşekkürler = Non, merci', emoji: '❌'),
        LessonItem(term: 'Hoşça kal', pronunciation: 'HOSH-cha kal', translation: 'Au revoir', example: 'Hoşça kal, görüşürüz! = Au revoir, à bientôt !', emoji: '👋'),
        LessonItem(term: 'Nasılsın?', pronunciation: 'na-SIL-sin', translation: 'Comment vas-tu ?', example: 'Nasılsın bugün? = Comment vas-tu aujourd\'hui ?', emoji: '🤔'),
        LessonItem(term: 'İyiyim', pronunciation: 'EE-yee-yim', translation: 'Je vais bien', example: 'İyiyim, teşekkürler = Je vais bien, merci', emoji: '😊'),
        LessonItem(term: 'İsmim ne?', pronunciation: 'is-MIM ne', translation: 'Mon nom est...', example: 'İsmim Ahmet = Je m\'appelle Ahmet', emoji: '👤'),
      ],
    },
    // ───────── ALLEMAND ─────────
    'de': {
